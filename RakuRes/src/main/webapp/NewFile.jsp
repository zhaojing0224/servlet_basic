...
<title>会員登録画面</title>
<link rel="stylesheet" type="text/css" href="/com/js/id/jquery-ui-1.11.4.custom/jquery-ui.min.css">
<link rel="stylesheet" type="text/css" href="/com/js/id/jquery-ui-1.11.4.custom/jquery-ui.theme.min.css">
<link rel="stylesheet" type="text/css" href="/com/css/id/iconselectmenu.css">
...
<input id="email" class="text" type="email" name="email"onclick="emailtFunction()"><br>
</td>
<script>
...
function emailFunction() 
 var emailValue = document.getElementById('email').value;
    ...
    var isValidEmail = regexEmail.test(emailValue);
 
    var emailError = document.querySelector('.userIderror');
    var emailErrorMessage = document.querySelector('.userIderrormes');
  
    if (!isValidEmail) {
        emailError.style.display = 'inline-block';
        emailErrorMessage.style.display = 'inline-block';
        emailErrorMessage.textContent = '入力されたメールアドレスの形式はご登録いただけません。';
    } else {
...
<em><6文字以上半角英数字><br>
  ...
  <input type="password" name="p" maxlength="128" size="20" value="" onkeydown="if(event.ctrlKey==true && event.keyCode==86)return false;" onkeypress="pFlagOn()" onfocus="pFocus(this)" id="p_id" title="(例) 18f5ns1kzm">
       <br><br>
</em>
</td>
<td class="end"><a href="">詳しいヘルプ</a></td>
...
<input type="submit" name="execMethod" value="同意して次へ" onclick="nextFunction();">
